...
model: inherit
skills: [exeris-docs-document-shape-classifier]
policies: [adr-registry]
handoffs:
  - {agent: exeris-docs-adr-registry-keeper, when: "the shape is ADR and a number must be reserved", blocking: true}
