...
1. **`exeris-kernel-core` Implementation:** Add package `eu.exeris.kernel.core.contract` containing `ExecutionContract`, `WorkloadEnvelope`, `EnforcementLevel`, and `ContractBreachException`.
