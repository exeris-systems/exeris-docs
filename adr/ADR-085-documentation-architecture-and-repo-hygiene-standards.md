...
| **Owning Repo** | `exeris-docs` |
| **Driven By**   | [RFC-2026-09-04 docs-guardrails open decisions](../rfc/RFC-2026-09-04-docs-guardrails-open-decisions.md); `standards/_inventory/2026-09-inventory.md`; `standards/_research/2026-09-reference-analysis.md`; `standards/_research/2026-09-generator-spike.md` |
...
- `exeris-docs/standards/_inventory/2026-09-inventory.md`, `standards/_research/2026-09-reference-analysis.md`, `standards/_research/2026-09-generator-spike.md` — evidence.
...
5. **Phase 6 — upkeep:** `docs-guardrails-audit.md` monthly routine (re-run `standards/_inventory/inventory.py`, diff, report `[DOC DEBT]` count and age); `doc-drift-check.md` written to use `last-verified`.
