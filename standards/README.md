...
| [`javadoc-conventions.md`](javadoc-conventions.md) | doc comments on Java API | per-repo `maven-javadoc-plugin`, `exeris-systems/.github` → `java/checkstyle-javadoc.xml` |
