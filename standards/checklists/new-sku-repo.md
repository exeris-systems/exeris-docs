...
6. **Empirical JVM baseline.** Have optimal default JVM settings ("optymalne domyślne ustawienia JVM") been determined through workload profiling, documented in `README.md`, and baked into the default container entrypoint?
